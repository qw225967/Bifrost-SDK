...
#ifndef NEBULA_RTC_BASE_TYPE_TRAITS_H_
#define NEBULA_RTC_BASE_TYPE_TRAITS_H_
...
namespace RTCUtils {
		...
		public:
				static constexpr bool value
				    = std::is_same<decltype(Test<DS>(0)), int>::value;
		};
		...
		public:
				static constexpr bool value = std::is_integral<X>::value
				                              || type_traits_impl::IsIntEnum<X>::value;
		};
...
#endif // NEBULA_RTC_BASE_TYPE_TRAITS_H_
